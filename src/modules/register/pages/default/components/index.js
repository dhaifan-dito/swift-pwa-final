            ...
            <form className={classNames('col-md-6', styles.container)} onSubmit={formik.handleSubmit}>
                            ...
                            codeProps={{
                                ...
                                footer: (
                                    <FormControlLabel
                                        ...
                                        label={<Typography variant="p" className={styles.titletwo}>{t('register:isWhatsapp')}</Typography>}
                                    />
                                ),
                            }}
                        />
                ...
                <div className={styles.footer}>
                    <FormControlLabel
                        ...
                        label={(
                            <Typography variant="p" letter="capitalize" className={styles.titletwo}>
                    ...
                    >
                        <Typography variant="span" type="bold" letter="uppercase" className={styles.titlethree}>
                            {t('register:button')}
                        </Typography>
                    </Button>
                </div>
